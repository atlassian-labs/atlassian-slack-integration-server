...
public class PageUpdateContentNotificationTest {
    @Mock
    ...
    @InjectMocks
    private PageUpdateContentNotification target;

    @Test
    public void supports_shouldReturnExpectedValue() {
        when(event.isPageUpdate()).thenReturn(true, false);
    ...
    public void getActivityKey_shouldReturnExpectedValueForPageCreate() {
        assertThat(target.getActivityKey(event), is(Optional.of("slack.activity.page-update")));
    }
