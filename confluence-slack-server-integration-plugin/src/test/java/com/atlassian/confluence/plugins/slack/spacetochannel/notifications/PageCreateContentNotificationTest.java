...
public class PageCreateContentNotificationTest {
    @Mock
    ...
    @InjectMocks
    private PageCreateContentNotification target;

    @Test
    public void supports_shouldReturnExpectedValue() {
        when(event.isPageCreate()).thenReturn(true, false);
    ...
    public void getActivityKey_shouldReturnExpectedValueForPageCreate() {
        assertThat(target.getActivityKey(event), is(Optional.of("slack.activity.page-create")));
    }
