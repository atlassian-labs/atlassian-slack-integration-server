...
public class DefaultServiceDeskCompatibilityHelperTest {
    ...
    public void getServiceDeskForProjectReturnsServiceDesk() {
        when(serviceDeskManager.getServiceDeskForProject(project)).thenReturn(serviceDesk);
    ...
    public void getPortalForProjectReturnsPortal() {
        when(portalManager.getPortalForProject(project)).thenReturn(portal);
    ...
    public void getRequestTypesReturnRequestTypes() {
        when(requestTypeService.getRequestTypes(user, query)).thenReturn(PagedResponseImpl.fromSingle(false, requestType).build());
    ...
    public void getTerminalClausePropertyReturnsProperty() {
        ...
        Object actualProperty = target.getTerminalClauseProperty(clause);

        assertThat(((Option<Property>) actualProperty).get(), sameInstance(property));
    }
